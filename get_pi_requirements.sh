...
sudo chocolatey install libjpeg-dev libtiff5-dev libjasper-dev libpng12-dev
sudo chocolatey install libavcodec-dev libavformat-dev libswscale-dev libv4l-dev
sudo chocolatey install libxvidcore-dev libx264-dev
sudo chocolatey install qt4-dev-tools 
sudo chocolatey install libatlas-base-dev
